...
type Todo struct {
	...
	Human    string    `form:"human" boil:"human" json:"human" toml:"human" yaml:"human"`
	...
	CreateAt time.Time `form:"create_at" boil:"create_at" json:"create_at" toml:"create_at" yaml:"create_at"`
...
var TodoWhere = struct {
	ID       whereHelperint
	Human    whereHelperstring
	Content  whereHelperstring
	Status   whereHelperint8
	CreateAt whereHelpertime_Time
}{
	ID:       whereHelperint{field: "`todo`.`id`"},
	Human:    whereHelperstring{field: "`todo`.`human`"},
	Content:  whereHelperstring{field: "`todo`.`content`"},
	Status:   whereHelperint8{field: "`todo`.`status`"},
	CreateAt: whereHelpertime_Time{field: "`todo`.`create_at`"},
}
...
var (
	todoAllColumns            = []string{"id", "human", "content", "status", "create_at"}
	todoColumnsWithoutDefault = []string{"human", "content", "status", "create_at"}
...
func (o *Todo) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update todo, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update todo row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for todo")
	}
...
func (q todoQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for todo")
	}
...
func (o *Todo) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for todo")
	}
...
func (q todoQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for todo")
	}
